...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Set-2014 às 09:23
...
--
-- Extraindo dados da tabela `ajax_pais`
--
...
--
-- Estrutura da tabela `apoio_idioma`
--
...
--
-- Extraindo dados da tabela `apoio_idioma`
--
...
--
-- Estrutura da tabela `apoio_titulacao`
--

CREATE TABLE IF NOT EXISTS `apoio_titulacao` (
  `id_ap_tit` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_ap_tit` (`id_ap_tit`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;

--
-- Extraindo dados da tabela `apoio_titulacao`
--
...
--
-- Estrutura da tabela `calender`
--

CREATE TABLE IF NOT EXISTS `calender` (
  `id_cal` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Extraindo dados da tabela `calender`
--
...
--
-- Estrutura da tabela `calender_type`
--

CREATE TABLE IF NOT EXISTS `calender_type` (
  `id_calt` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_calt` (`id_calt`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;

--
-- Extraindo dados da tabela `calender_type`
--
...
--
-- Estrutura da tabela `cep_action`
--
...
--
-- Extraindo dados da tabela `cep_action`
--
...
--
-- Estrutura da tabela `cep_action_permission`
--

CREATE TABLE IF NOT EXISTS `cep_action_permission` (
  `id_actionp` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `actionp_action` char(3) NOT NULL,
  `actionp_perfil` char(4) NOT NULL,
  `actionp_ativa` int(11) NOT NULL,
  UNIQUE KEY `id_actionp` (`id_actionp`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=19 ;

--
-- Extraindo dados da tabela `cep_action_permission`
--
...
--
-- Estrutura da tabela `cep_amendment_type`
--

CREATE TABLE IF NOT EXISTS `cep_amendment_type` (
  `id_amt` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_amt` (`id_amt`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Extraindo dados da tabela `cep_amendment_type`
--
...
--
-- Estrutura da tabela `cep_comment`
--

CREATE TABLE IF NOT EXISTS `cep_comment` (
  `id_cepc` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_cepc` (`id_cepc`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Extraindo dados da tabela `cep_comment`
--
...
(2, '0000101', '0000008', 'este estudo foi apresentado em outro comite no Peru, lÃ¡ nÃ£o foi aprovado. Rever com cuidade....', 20130319, '10:34:37', '1'),
...
--
-- Extraindo dados da tabela `cep_email`
--
...
(0, '', 20130319, '10:36:17', 'ComitÃª da PUCPR - 0000101', 'pro....', '0000101', 'A', '', '', 'A'),
(0, '', 20130822, '03:20:10', 'Proyecto rechazado', 'NÃ£o foram postados os arquivos anexos', '0000105', 'A', '', '', 'A'),
(0, '', 20131017, '13:33:32', 'PAHO Committee Ethics - ProEthos - 0000117', 'propuesta recibida....adlfgknd;oadg;kjadbg;kjadgk;adga', '0000117', 'A', '', '', 'A');

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_ged_documento`
--
...
--
-- Extraindo dados da tabela `cep_ged_documento`
--
...
--
-- Estrutura da tabela `cep_ged_documento_tipo`
--

CREATE TABLE IF NOT EXISTS `cep_ged_documento_tipo` (
  `id_doct` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_doct` (`id_doct`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=10 ;

--
-- Extraindo dados da tabela `cep_ged_documento_tipo`
--
...
--
-- Estrutura da tabela `cep_parecer`
--
...
--
-- Extraindo dados da tabela `cep_parecer`
--
...
(1, '000001', 1, 'APR', 'F', 'bvjv,v,jhv', '', '', '', '', '', '', '', '', '', '', 20140708, '17:02', '', 1, 20140708, '', -1);
...
CREATE TABLE IF NOT EXISTS `cep_parecer` (
  `id_pp` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `cep_parecer` (`id_pp`, `pp_nrparecer`, `pp_tipo`, `pp_protocolo`, `pp_protocolo_mae`, `pp_avaliador`, `pp_revisor`, `pp_status`, `pp_pontos`, `pp_pontos_pp`, `pp_data`, `pp_hora`, `pp_parecer_data`, `pp_parecer_hora`, `pp_p01`, `pp_p02`, `pp_p03`, `pp_p04`, `pp_p05`, `pp_p06`, `pp_p07`, `pp_p08`, `pp_p09`, `pp_p10`, `pp_p11`, `pp_p12`, `pp_p13`, `pp_p14`, `pp_p15`, `pp_p16`, `pp_p17`, `pp_p18`, `pp_p19`, `pp_abe_01`, `pp_abe_02`, `pp_abe_03`, `pp_abe_04`, `pp_abe_05`, `pp_abe_06`, `pp_abe_07`, `pp_abe_08`, `pp_abe_09`, `pp_abe_10`, `pp_data_leitura`) VALUES
(1, '', 'PAREC', '000002', '', '0000018', '', 'A', 0, 0, 20140617, '01:58', 20140617, '01:59', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', '', NULL, NULL, NULL, NULL, 19000101),
(2, '', 'PAREC', '000001', '', '0000017', '', '@', 0, 0, 20140708, '16:57', 19000101, '00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19000101),
(3, '', 'PAREC', '000001', '', '0000032', '', '@', 0, 0, 20140708, '16:57', 19000101, '00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19000101);

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_protocolos`
--

CREATE TABLE IF NOT EXISTS `cep_protocolos` (
  `id_cep` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_cep` (`id_cep`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Extraindo dados da tabela `cep_protocolos`
--

INSERT INTO `cep_protocolos` (`id_cep`, `cep_codigo`, `cep_tipo`, `cep_protocol`, `cep_fr`, `cep_versao`, `cep_data`, `cep_hora`, `cep_resumo`, `cep_study_type`, `cep_goal`, `cep_pesquisador`, `cep_local_realizacao`, `cep_status`, `cep_ata`, `cep_dt_parecer`, `cep_titulacao`, `cep_grupo`, `cep_titulo`, `cep_titulo_public`, `cep_conhecimento`, `cep_caae`, `cep_atualizado`, `cep_atual`, `cep_relator`, `cep_reuniao`, `cep_st_parecer`, `cep_nr_parecer`, `cep_revisor`, `cep_atual_revisor`, `cep_submit`, `cep_dt_ciencia`, `cep_dt_liberacao`, `cep_sinte`, `cep_comment_pos`, `cep_comment_neg`, `cep_dictamen`, `cep_approved`, `cep_clinic`, `cep_xml`, `cep_recrutamento`, `cep_monitoring`, `cep_aproved`) VALUES
(1, '0000004', 'PRO', '000001', '0000004', '1', 20140613, '07:53', '', '', '', '0000008', '', 'P', '', 20140708, '', 'I', 'TESTE', 'TESTE', '', 'BR01.000001.001', 20140708, '', '', 20140805, '', '', '', NULL, '', 19000101, 20140708, '', 1, 0, 0, 0, '0', '', 0, 0, 0),
(2, '0000006', 'PRO', '000002', '0000006', '1', 20140617, '01:45', '', '', '', '0000017', '', 'D', '', 19000101, '', 'I', 'TEST XYZ', 'TEST XYZ', '', 'BR01.000002.001', 20140617, '', '', 20140701, '', '', '', NULL, '', 19000101, 19000101, '', 0, 0, 0, 0, '1', '', 0, 0, 0),
(3, '0000007', 'PRO', '000003', '0000007', '1', 20140708, '16:46', '', '', '', '0000018', '', 'B', '', 19000101, '', 'I', 'Test El Salvador', 'El Salvador', '', '', 20140910, '', '', 19000101, '', '', '', NULL, '', 19000101, 19000101, '', 0, 0, 0, 0, '1', '', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_protocolos_historic`
--

CREATE TABLE IF NOT EXISTS `cep_protocolos_historic` (
  `id_his` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_his` (`id_his`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=13 ;

--
-- Extraindo dados da tabela `cep_protocolos_historic`
--
...
(5, '000002', '011', 20140617, '01:59', 'Asignar para reuniÃ³n', '0000018', ''),
...
(9, '000001', '011', 20140708, '16:58', 'Asignar para reuniÃ³n', '0000018', ''),
...
--
-- Estrutura da tabela `cep_protocol_log`
--

CREATE TABLE IF NOT EXISTS `cep_protocol_log` (
  `id_cl` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Extraindo dados da tabela `cep_protocol_log`
--

INSERT INTO `cep_protocol_log` (`id_cl`, `cl_data`, `cl_hora`, `cl_protocol`, `cl_cod`) VALUES
(1, 20130124, '12:13:54', '0000091', '#status_A'),
(2, 20130124, '12:24:17', '0000091', '#status_A'),
(3, 20130124, '12:42:23', '0000091', '#status_A'),
(4, 20130124, '18:39:58', '0000096', '#status_A'),
(5, 20130319, '06:27:03', '0000099', '#status_A'),
(6, 20130319, '07:30:59', '0000100', '#status_A'),
(7, 20130319, '10:09:46', '0000101', '#status_A'),
(8, 20130510, '11:58:51', '0000109', '#status_A'),
(9, 20130511, '11:48:49', '0000110', '#status_A'),
(10, 20130531, '12:24:34', '0000111', '#status_A'),
(11, 20130822, '03:12:33', '0000105', '#status_A'),
(12, 20130822, '03:47:40', '0000105', '#status_A'),
(13, 20130923, '15:47:40', '0000115', '#status_A'),
(14, 20131015, '16:26:58', '0000114', '#status_A'),
(15, 20131017, '13:31:30', '0000117', '#status_A'),
(16, 20140613, '07:53:23', '0000004', '#status_A'),
(17, 20140617, '01:45:42', '0000006', '#status_A'),
(18, 20140708, '16:46:37', '0000007', '#status_A');

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_status`
--

CREATE TABLE IF NOT EXISTS `cep_status` (
  `id_ess` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_ess` (`id_ess`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=41 ;

--
-- Extraindo dados da tabela `cep_status`
--
...
--
-- Estrutura da tabela `cep_submit_country`
--

CREATE TABLE IF NOT EXISTS `cep_submit_country` (
  `id_ctr` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `ctr_protocol` char(7) NOT NULL,
  `ctr_country` char(5) NOT NULL,
  `ctr_ativo` int(11) NOT NULL,
  `ctr_target` int(11) NOT NULL,
  UNIQUE KEY `id_ctr` (`id_ctr`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;

--
-- Extraindo dados da tabela `cep_submit_country`
--

INSERT INTO `cep_submit_country` (`id_ctr`, `ctr_protocol`, `ctr_country`, `ctr_ativo`, `ctr_target`) VALUES
(1, '0000004', '00040', 1, 12),
(2, '0000007', '00078', 1, 200);

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_submit_crono`
--

CREATE TABLE IF NOT EXISTS `cep_submit_crono` (
  `id_scrono` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_scrono` (`id_scrono`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Extraindo dados da tabela `cep_submit_crono`
--
...
(1, 'tese', 201506, 201612, '0000004', 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_submit_documento`
--
...
--
-- Extraindo dados da tabela `cep_submit_documento`
--

INSERT INTO `cep_submit_documento` (`id_doc`, `doc_1_titulo`, `doc_1_titulo_public`, `doc_protocolo`, `doc_tipo`, `doc_human`, `doc_clinic`, `doc_data`, `doc_hora`, `doc_dt_atualizado`, `doc_autor_principal`, `doc_research_main`, `doc_status`, `doc_xml`, `doc_type`, `doc_caae`) VALUES
(1, 'xyz', 'xyz', '0000001', '', 1, 1, 20131218, '16:04', 20131219, '0000018', '0000018', 'X', '', '', ''),
(2, 'testx', 'testx', '0000002', '', 1, 0, 20140123, '16:56', 20140123, '0000026', '0000026', '@', '', '', ''),
(3, 'sgnsfhsfghsffghsfghsgfs', 'fgsbsdbsdfbsfndhndhnd', '0000003', '', 1, 1, 20140204, '20:06', 20140708, '0000018', '0000018', '@', '', '', ''),
(4, 'TESTE', 'TESTE', '0000004', '', 1, 0, 20140613, '07:46', 20140613, '0000008', '0000008', 'A', '', '', ''),
(5, 'Test 200', 'Test 200', '0000005', '', 1, 1, 20140611, '00:05', 20140611, '0000029', '0000029', '@', '', '', ''),
(6, 'TEST XYZ', 'TEST XYZ', '0000006', '', 1, 1, 20140617, '01:28', 20140617, '0000017', '0000017', 'A', '', '', ''),
(7, 'Test El Salvador', 'El Salvador', '0000007', '', 1, 1, 20140708, '16:39', 20140708, '0000018', '0000018', 'A', '', '', '');

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_submit_documentos_obrigatorio`
--

CREATE TABLE IF NOT EXISTS `cep_submit_documentos_obrigatorio` (
  `id_sdo` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_sdo` (`id_sdo`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Extraindo dados da tabela `cep_submit_documentos_obrigatorio`
--
...
--
-- Estrutura da tabela `cep_submit_documento_valor`
--

CREATE TABLE IF NOT EXISTS `cep_submit_documento_valor` (
  `id_spc` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_spc` (`id_spc`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=209 ;

--
-- Extraindo dados da tabela `cep_submit_documento_valor`
--

INSERT INTO `cep_submit_documento_valor` (`id_spc`, `spc_codigo`, `spc_projeto`, `spc_content`, `spc_ativo`, `spc_pagina`, `spc_autor`) VALUES
(1, '00065', '0000004', '', 1, '002', '0000008'),
(2, '00064', '0000004', '', 1, '002', '0000008'),
(3, '00066', '0000004', '', 1, '002', '0000008'),
(4, '00006', '0000004', '', 1, '002', '0000008'),
(5, '00002', '0000004', 'summaty', 1, '002', '0000008'),
(6, '00008', '0000004', 'keywords', 1, '002', '0000008'),
(7, '00007', '0000004', '', 1, '002', '0000008'),
(8, '00003', '0000004', '', 1, '002', '0000008'),
(9, '00004', '0000004', 'instroduÃ§Ã£o', 1, '002', '0000008'),
(10, '00030', '0000004', 'justificativa', 1, '002', '0000008'),
(11, '00011', '0000004', 'objetivo', 1, '002', '0000008'),
(12, '00005', '0000004', '', 1, '002', '0000008'),
(13, '00005', '0000004', '', 1, '002', '0000008'),
(14, '00035', '0000004', '', 1, '003', '0000008'),
(15, '00010', '0000004', 'desenho', 1, '003', '0000008'),
(16, '00001', '0000004', '', 1, '003', '0000008'),
(17, '00067', '0000004', '', 1, '003', '0000008'),
(18, '00069', '0000004', '#both', 1, '003', '0000008'),
(19, '00029', '0000004', '120', 1, '003', '0000008'),
(20, '00070', '0000004', '10', 1, '003', '0000008'),
(21, '00071', '0000004', '34', 1, '003', '0000008'),
(22, '00027', '0000004', 'critÃ©rio de inclusÃ£o', 1, '003', '0000008'),
(23, '00028', '0000004', 'critÃ©rio de exclusÃ£o', 1, '003', '0000008'),
(24, '00068', '0000004', '', 1, '003', '0000008'),
(25, '00072', '0000004', '', 1, '003', '0000008'),
(26, '00022', '0000004', '01/01/2015', 1, '003', '0000008'),
(27, '00042', '0000004', '', 1, '003', '0000008'),
(28, '00026', '0000004', '', 1, '003', '0000008'),
(29, '00073', '0000004', '', 1, '003', '0000008'),
(30, '00020', '0000004', 'intervenÃ§Ãµes', 1, '003', '0000008'),
(31, '00016', '0000004', '', 1, '003', '0000008'),
(32, '00017', '0000004', 'primario', 1, '003', '0000008'),
(33, '00018', '0000004', 'secundario', 1, '003', '0000008'),
(34, '00019', '0000004', '', 1, '003', '0000008'),
(35, '00031', '0000004', 'procedimentos gerais', 1, '003', '0000008'),
(36, '00032', '0000004', 'plano de anÃ¡lise', 1, '003', '0000008'),
(37, '00023', '0000004', 'condiÃ§Ãµes Ã©ticos', 1, '003', '0000008'),
(38, '00023', '0000004', 'condiÃ§Ãµes Ã©ticos', 1, '003', '0000008'),
(39, '00038', '0000004', '', 1, '004', '0000008'),
(40, '00039', '0000004', '', 1, '004', '0000008'),
(41, '00034', '0000004', '', 1, '004', '0000008'),
(42, '00045', '0000004', '', 1, '004', '0000008'),
(43, '00047', '0000004', '', 1, '004', '0000008'),
(44, '00033', '0000004', 'prÃ³prio', 1, '004', '0000008'),
(45, '00040', '0000004', 'primario', 1, '004', '0000008'),
(46, '00041', '0000004', 'secundÃ¡rio', 1, '004', '0000008'),
(47, '00046', '0000004', '', 1, '004', '0000008'),
(48, '00036', '0000004', '', 1, '004', '0000008'),
(49, '00036', '0000004', '', 1, '004', '0000008'),
(50, '00049', '0000004', '', 1, '005', '0000008'),
(51, '00024', '0000004', 'bibliogrÃ¡fia', 1, '005', '0000008'),
(52, '00050', '0000004', '', 1, '005', '0000008'),
(53, '00054', '0000004', '', 1, '005', '0000008'),
(54, '00056', '0000004', 'contato', 1, '005', '0000008'),
(55, '00057', '0000004', '', 1, '005', '0000008'),
(56, '00084', '0000004', '', 1, '005', '0000008'),
(57, '00083', '0000004', '#YES', 1, '005', '0000008'),
(58, '00086', '0000004', '', 1, '005', '0000008'),
(59, '00085', '0000004', '', 1, '005', '0000008'),
(60, '00043', '0000004', '', 1, '005', '0000008'),
(61, '00043', '0000004', '', 1, '005', '0000008'),
(62, '00065', '0000006', '', 1, '002', '0000017'),
(63, '00064', '0000006', '', 1, '002', '0000017'),
(64, '00066', '0000006', '', 1, '002', '0000017'),
(65, '00006', '0000006', '', 1, '002', '0000017'),
(66, '00002', '0000006', 'afgadf  dagdfjafd dfjaadf dfjhhkh; kkjkadjhf; adfjhad;fjad;fj', 1, '002', '0000017'),
(67, '00008', '0000006', 'dfasfgasd, adfadfad, adfgafgsd', 1, '002', '0000017'),
(68, '00007', '0000006', '', 1, '002', '0000017'),
(69, '00003', '0000006', '', 1, '002', '0000017'),
(70, '00004', '0000006', 'jadf;aodhf ;orfh;odjfna;dkvbadfvadkvnalfvn;adfvn;adlfvnaflvm x,cvm zx,.', 1, '002', '0000017'),
(71, '00030', '0000006', 'xva.dnf;valdfnvaldfvnadfvlnac/m cvzc v,', 1, '002', '0000017'),
(72, '00011', '0000006', 'xlkznvx;lzxc vz,mc v/ mzczc,vmnz/lc', 1, '002', '0000017'),
(73, '00005', '0000006', '', 1, '002', '0000017'),
(74, '00005', '0000006', '', 1, '002', '0000017'),
(75, '00035', '0000006', '', 1, '003', '0000017'),
(76, '00010', '0000006', 'xxcvxcbnmfh,fjk,mn   knlkn /lnk lknlknl/', 1, '003', '0000017'),
(77, '00001', '0000006', 'dgadgadgadadfgad dgadgadfgdfg hstghsfhsfghfg', 1, '003', '0000017'),
(78, '00067', '0000006', '', 1, '003', '0000017'),
(79, '00069', '0000006', '#women', 1, '003', '0000017'),
(80, '00029', '0000006', '200', 1, '003', '0000017'),
(81, '00070', '0000006', '0', 1, '003', '0000017'),
(82, '00071', '0000006', '0', 1, '003', '0000017'),
(83, '00027', '0000006', 'zvxcadfvadfva dbadfgadfgsdf gbsfgbsgbsfgb', 1, '003', '0000017'),
(84, '00028', '0000006', '', 1, '003', '0000017'),
(85, '00068', '0000006', '', 1, '003', '0000017'),
(86, '00072', '0000006', '', 1, '003', '0000017'),
(87, '00022', '0000006', '01/07/2014', 1, '003', '0000017'),
(88, '00042', '0000006', 'pending', 1, '003', '0000017'),
(89, '00026', '0000006', '', 1, '003', '0000017'),
(90, '00073', '0000006', '', 1, '003', '0000017'),
(91, '00020', '0000006', 'gsfgsfgbsfgbsfgnsnxvbnxvbx', 1, '003', '0000017'),
(92, '00016', '0000006', '', 1, '003', '0000017'),
(93, '00017', '0000006', 'nfgnsfgnxvbxbv xvb xvb', 1, '003', '0000017'),
(94, '00018', '0000006', 'bxvbnvzbnxvbnxvbnxvbnxvb', 1, '003', '0000017'),
(95, '00019', '0000006', '', 1, '003', '0000017'),
(96, '00031', '0000006', 'ghsfghsfghsfghsfghsfghsfghsfghsfg', 1, '003', '0000017'),
(97, '00032', '0000006', 'xnsfnshgnsghnln.b, n .mn .m', 1, '003', '0000017'),
(98, '00023', '0000006', 'blbkcn.,vmcnv,mc .nm b.mn', 1, '003', '0000017'),
(99, '00023', '0000006', 'blbkcn.,vmcnv,mc .nm b.mn', 1, '003', '0000017'),
(100, '00038', '0000006', '', 1, '004', '0000017'),
(101, '00039', '0000006', '', 1, '004', '0000017'),
(102, '00034', '0000006', '', 1, '004', '0000017'),
(103, '00045', '0000006', '', 1, '004', '0000017'),
(104, '00047', '0000006', '', 1, '004', '0000017'),
(105, '00033', '0000006', 'sfgsfghsfghsfghsffhsfgfg', 1, '004', '0000017'),
(106, '00040', '0000006', 'sfhsfghsfghsfghsfghsfghsfghsfg', 1, '004', '0000017'),
(107, '00041', '0000006', '', 1, '004', '0000017'),
(108, '00046', '0000006', '', 1, '004', '0000017'),
(109, '00036', '0000006', '', 1, '004', '0000017'),
(110, '00036', '0000006', '', 1, '004', '0000017'),
(111, '00049', '0000006', '', 1, '005', '0000017'),
(112, '00024', '0000006', 'kd;gjkfbdk.gjadbfgm.and.lgake;glab.dvm mvb cv b,mdgn.adfg/amdfgnf,mfa bv,.m.zcnm', 1, '005', '0000017'),
(113, '00050', '0000006', '', 1, '005', '0000017'),
(114, '00054', '0000006', '', 1, '005', '0000017'),
(115, '00056', '0000006', 'fagdfgadgadgadfgadfgadfga', 1, '005', '0000017'),
(116, '00057', '0000006', '', 1, '005', '0000017'),
(117, '00084', '0000006', '', 1, '005', '0000017'),
(118, '00083', '0000006', '#YES', 1, '005', '0000017'),
(119, '00086', '0000006', '', 1, '005', '0000017'),
(120, '00085', '0000006', '', 1, '005', '0000017'),
(121, '00043', '0000006', '', 1, '005', '0000017'),
(122, '00043', '0000006', '', 1, '005', '0000017'),
(123, '00065', '0000007', '', 1, '002', '0000018'),
(124, '00064', '0000007', '', 1, '002', '0000018'),
(125, '00066', '0000007', '', 1, '002', '0000018'),
(126, '00006', '0000007', '', 1, '002', '0000018'),
(127, '00002', '0000007', 'gsghsf', 1, '002', '0000018'),
(128, '00008', '0000007', 'jhvjhvj', 1, '002', '0000018'),
(129, '00007', '0000007', '', 1, '002', '0000018'),
(130, '00003', '0000007', '', 1, '002', '0000018'),
(131, '00004', '0000007', 'nbkjbklbj', 1, '002', '0000018'),
(132, '00030', '0000007', 'jhkjgkj', 1, '002', '0000018'),
(133, '00011', '0000007', 'lnlkbnklb', 1, '002', '0000018'),
(134, '00005', '0000007', '', 1, '002', '0000018'),
(135, '00005', '0000007', '', 1, '002', '0000018'),
(179, '00017', '0000007', 'vbdzbzdgcbzfgbbz', 1, '003', '0000018'),
(178, '00016', '0000007', '', 1, '003', '0000018'),
(177, '00020', '0000007', 'adgfg', 1, '003', '0000018'),
(176, '00073', '0000007', '', 1, '003', '0000018'),
(175, '00026', '0000007', '', 1, '003', '0000018'),
(174, '00042', '0000007', 'pending', 1, '003', '0000018'),
(173, '00022', '0000007', '29/07/2014', 1, '003', '0000018'),
(172, '00072', '0000007', '', 1, '003', '0000018'),
(171, '00068', '0000007', '', 1, '003', '0000018'),
(170, '00028', '0000007', '', 1, '003', '0000018'),
(169, '00027', '0000007', 'kjbkjbkjb', 1, '003', '0000018'),
(168, '00071', '0000007', '0', 1, '003', '0000018'),
(167, '00070', '0000007', '0', 1, '003', '0000018'),
(166, '00029', '0000007', '200', 1, '003', '0000018'),
(165, '00069', '0000007', '#both', 1, '003', '0000018'),
(164, '00067', '0000007', '', 1, '003', '0000018'),
(163, '00001', '0000007', 'lnlknlnl', 1, '003', '0000018'),
(162, '00010', '0000007', 'mnkjbnlk', 1, '003', '0000018'),
(161, '00035', '0000007', '', 1, '003', '0000018'),
(180, '00018', '0000007', 'm ,m nl,kmbnkjn', 1, '003', '0000018'),
(181, '00019', '0000007', '', 1, '003', '0000018'),
(182, '00031', '0000007', 'jhvjhbv jh', 1, '003', '0000018'),
(183, '00032', '0000007', 'jhghjkvkhj', 1, '003', '0000018'),
(184, '00023', '0000007', 'hvkjhvljhv', 1, '003', '0000018'),
(185, '00023', '0000007', 'hvkjhvljhv', 1, '003', '0000018'),
(186, '00038', '0000007', '', 1, '004', '0000018'),
(187, '00039', '0000007', '', 1, '004', '0000018'),
(188, '00034', '0000007', '', 1, '004', '0000018'),
(189, '00045', '0000007', '', 1, '004', '0000018'),
(190, '00047', '0000007', '', 1, '004', '0000018'),
(191, '00033', '0000007', 'hlhgljhvlhjv', 1, '004', '0000018'),
(192, '00040', '0000007', 'jb.kvv.kjvkj', 1, '004', '0000018'),
(193, '00041', '0000007', '', 1, '004', '0000018'),
(194, '00046', '0000007', '', 1, '004', '0000018'),
(195, '00036', '0000007', '', 1, '004', '0000018'),
(196, '00036', '0000007', '', 1, '004', '0000018'),
(197, '00049', '0000007', '', 1, '005', '0000018'),
(198, '00024', '0000007', 'jhvkjhv,jhv,mnv m', 1, '005', '0000018'),
(199, '00050', '0000007', '', 1, '005', '0000018'),
(200, '00054', '0000007', '', 1, '005', '0000018'),
(201, '00056', '0000007', 'nmv,jv,jhv.khv', 1, '005', '0000018'),
(202, '00057', '0000007', '', 1, '005', '0000018'),
(203, '00084', '0000007', '', 1, '005', '0000018'),
(204, '00083', '0000007', '#YES', 1, '005', '0000018'),
(205, '00086', '0000007', '', 1, '005', '0000018'),
(206, '00085', '0000007', '', 1, '005', '0000018'),
(207, '00043', '0000007', '', 1, '005', '0000018'),
(208, '00043', '0000007', '', 1, '005', '0000018');

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_submit_ged_files`
--

CREATE TABLE IF NOT EXISTS `cep_submit_ged_files` (
  `id_pl` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estrutura da tabela `cep_submit_grupos`
--

CREATE TABLE IF NOT EXISTS `cep_submit_grupos` (
  `id_sg` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `if_sg` (`id_sg`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_submit_institution_dados`
--

CREATE TABLE IF NOT EXISTS `cep_submit_institution_dados` (
  `id_sid` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `sid_institution` char(7) NOT NULL,
  `sid_protocol` char(7) NOT NULL,
  `sid_field` char(7) NOT NULL,
  `sid_update` int(11) NOT NULL,
  UNIQUE KEY `id_sid` (`id_sid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_submit_manuscrito_field`
--
...
CREATE TABLE IF NOT EXISTS `cep_submit_manuscrito_field` (
  ...
  UNIQUE KEY `id_sub` (`id_sub`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=87 ;

--
-- Extraindo dados da tabela `cep_submit_manuscrito_field`
--
...
--
-- Estrutura da tabela `cep_submit_manuscrito_tipo`
--
...
--
-- Extraindo dados da tabela `cep_submit_manuscrito_tipo`
--
...
--
-- Estrutura da tabela `cep_submit_orca`
--

CREATE TABLE IF NOT EXISTS `cep_submit_orca` (
  `id_sorca` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_sorca` (`id_sorca`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Extraindo dados da tabela `cep_submit_orca`
--
...
--
-- Estrutura da tabela `cep_submit_register_unit`
--

CREATE TABLE IF NOT EXISTS `cep_submit_register_unit` (
  `id_csru` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_csru` (`id_csru`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;

--
-- Extraindo dados da tabela `cep_submit_register_unit`
--

INSERT INTO `cep_submit_register_unit` (`id_csru`, `csru_protocolo`, `csru_unit`, `csru_number`, `csru_ativo`, `csru_data`) VALUES
(1, 6, '00016', '123456', 1, '.01/01/01.'),
(2, 7, '00016', '1234', 1, '.01/01/01.');

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_submit_team`
--
...
--
-- Extraindo dados da tabela `cep_submit_team`
--

INSERT INTO `cep_submit_team` (`id_ct`, `ct_protocol`, `ct_author`, `ct_type`, `ct_data`, `ct_ativo`) VALUES
(1, '0000004', '0000009', 'C', 20140613, 1),
(2, '0000006', '0000017', 'C', 20140617, 1),
(3, '0000007', '0000018', 'C', 20140708, 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_submit_tipo`
--
...
--
-- Extraindo dados da tabela `cep_submit_tipo`
--
...
--
-- Estrutura da tabela `cep_submit_valor`
--
...
--
-- Estrutura da tabela `cep_survey`
--

CREATE TABLE IF NOT EXISTS `cep_survey` (
  `id_sr` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_sr` (`id_sr`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Estrutura da tabela `cep_team`
--
...
--
-- Extraindo dados da tabela `cep_team`
--

INSERT INTO `cep_team` (`id_ct`, `ct_protocol`, `ct_author`, `ct_type`, `ct_data`, `ct_ativo`) VALUES
(1, '000001', '0000009', 'C', 20140613, 1),
(2, '000002', '0000017', 'C', 20140617, 1),
(3, '000003', '0000018', 'C', 20140708, 1);
...
(11, 'teste', 'teste - resposta', 83, 0, 'CEP', 'en_US'),
(12, 'teste 2', 'teste - resposta', 1, 0, 'CEP', 'en_US');
...
CREATE TABLE IF NOT EXISTS `frases` (
  `id_fr` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `fr_word` char(20) DEFAULT NULL,
  `fr_texto` text,
  `fr_idioma` char(5) DEFAULT 'pt_BR',
  `journal_id` int(11) DEFAULT NULL,
  UNIQUE KEY `id_fr` (`id_fr`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Estrutura da tabela `ged_documento`
--
...
--
-- Extraindo dados da tabela `ged_documento`
--
...
--
-- Estrutura da tabela `ged_documento_tipo`
--
...
--
-- Extraindo dados da tabela `ged_documento_tipo`
--
...
--
-- Estrutura da tabela `ic_noticia`
--

CREATE TABLE IF NOT EXISTS `ic_noticia` (
  `id_nw` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_nw` (`id_nw`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=12 ;

--
-- Extraindo dados da tabela `ic_noticia`
--
...
(2, 20130104, 1, '', '', 'Forgot e-mail', 'Prezado Investigador,\r\n\r\nConforme sua solicitaÃ§Ã£o foi encaminho um e-mail com sua senha.', 19000101, 19000101, NULL, NULL, 'send_email_text', NULL, 'pt_BR', 0, 0),
...
--
-- Estrutura da tabela `instituion_action`
--

CREATE TABLE IF NOT EXISTS `instituion_action` (
  `id_ia` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `ia_codigo` char(5) DEFAULT NULL,
  `ia_descricao` char(60) DEFAULT NULL,
  `ess_ativo` bigint(20) DEFAULT '1',
  UNIQUE KEY `id_ia` (`id_ia`)
...
--
-- Estrutura da tabela `institution_action`
--
...
--
-- Extraindo dados da tabela `institution_action`
--
...
--
-- Estrutura da tabela `parecer_modelo`
--

CREATE TABLE IF NOT EXISTS `parecer_modelo` (
  `id_pm` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_pm` (`id_pm`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Extraindo dados da tabela `parecer_modelo`
--
...
--
-- Estrutura da tabela `submit_manuscrito_field`
--
...
--
-- Estrutura da tabela `submit_manuscrito_tipo`
--
...
(8, '0000008', 'Rene Faustino Gabriel Junior', 'active', 0, '', 'laguna', '0000008', 0, 0, 1, 'renefgj@gmail.com', 'rene@sisdoc.com.br', 1, 'Rua Padre Agostinho, 2885\r\nAp. 1203 - Torre Barigui\r\nCuritiba - ParanÃ¡ - Brasil\r\n55 41 8811.9061', '', 'PUCPR', '', '00040', 0, '', 0, '#RES#ADM#MST#MEM', 0),
(9, '0000009', 'Rene Faustino Gabriel Junior', '0000009', 0, '', '448545', '0000009', 0, 0, 1, 'rene@sisdoc.com.br', '', 0, 'Rua Padre Agostinho, 2885\r\nAp. 1203', '', 'PUCPR', '', '00040', 0, '', 0, '#RES#MEM#RES', 0),
(10, '0000010', 'Sergio Surugi de Siqueira', '0000010', 0, '', 'duck10', '0000010', 0, 0, 1, 'sergio.surugi@gmail.com', 'sergio.siqueira@pucpr.br', 0, 'PUCPR\r\nCuritiba', '', 'PontifÃ­cia Universidade CatÃ³lica do ParanÃ¡', '', '00040', 0, '', 0, '#RES#SCR#ADM', 0),
(11, '0000011', 'ClÃ¡udio Nishizawa', '0000011', 0, '', '3632427', '0000011', 0, 0, 1, 'claudio.fsp.usp@gmail.com', '', 0, 'Brasillia', '', 'Agencia Nacional de Vigilancia Sanitaria', '', '00040', 0, '', 0, '#RES#MEM#ADM', 0),
(38, '0000038', 'Rene Faustino Gabriel Junior', '0000038', 0, '', '448545ct', '0000038', 0, 0, -1, 'teste3@fonzaghi.com.br', '', 0, 'Street name\r\nCx Box\r\nCity name', '', 'PUCPR', '', '00040', 0, '', 0, '#RES', 20131122),
(17, '0000017', 'Carla Saenz', '0000017', 0, '', 'camila', '0000017', 0, 0, 1, 'saenzcar@paho.org', '', 0, '525 23rd st NW Washington DC 20037', '', 'PAHO', '', '00240', 0, '', 0, '#RES#ADM#COO#RES#MEM#SCR', 0),
(18, '0000018', 'Tania Flores', '0000018', 0, '', 'abrahamt03', '0000018', 0, 0, 1, 'abrahamsent@paho.org', 'trivasf@gmail.com', 0, '525 23rd St NW Washington DC 20037', '', 'Pan American Health Organization', '', '00240', 0, '', 0, '#MST#ADM#RES#MEM', 0),
(37, '0000037', 'Rene Faustino Gabriel Junior', '0000037', 0, '', '448545ct', '0000037', 0, 0, -1, 'teste2@fonzaghi.com.br', '', 0, 'Street name\r\nCx Box\r\nCity name', '', 'PUCPR', '', '00040', 0, '', 0, '#RES', 20131122),
(36, '0000036', 'Rene Faustino Gabriel Junior', '0000036', 0, '', '448545ct', '0000036', 0, 0, -1, 'teste@fonzaghi.com.br', '', 0, 'Street name\r\nCx Box\r\nCity name', '', 'PUCPR', '', '00040', 0, '', 0, '#RES', 20131122),
(26, '0000026', 'Rebecca Cruz', '0000026', 0, '', '12345678', '0000026', 0, 0, -1, 'cruzrebe@paho.org', '', 0, 'Street name\r\nCx Box\r\nCity name', '', 'PAHO GDR', '', '00240', 0, '', 0, '#RES', 20121217),
(27, '0000027', 'Dolors Montserrat-Capella', '0000027', 0, '', '12345', '0000027', 0, 0, -1, 'capella@capella.com.br', '', 0, 'not informed', '', 'not informed', '', '00152', 0, '', 0, '#RES', 20130123),
(28, '0000028', 'Rafa Fernandez', '0000028', 0, '', 'cocoloco', '0000028', 0, 0, -1, 'ferralech@gmail.com', '', 0, 'SAN SALVADOR', '', 'Independiente', '', '00078', 0, '', 0, '#RES', 20130130),
(29, '0000029', 'Katherine Ghimenti', '0000029', 0, '', 'virtues1', '0000029', 0, 0, 1, 'ghimentk@paho.org', '', 0, 'PAHO', '', 'PAHO-HSS', '', '00240', 0, '', 0, '#RES#ADM', 20130329),
(30, '0000030', 'Ricardo Gamarski', '0000030', 0, '', 'rgfioc98', '0000030', 0, 0, -1, 'Ricardo.gamarski@gmail.com', 'Ricardo.gamarski@globo.com', 0, 'BrasÃ­lia, DF, Brasil', '', 'New User Institution', '', '00040', 0, '', 0, '#RES', 20130424),
(31, '0000031', 'JACKELINE BRAVO CHAMORRO', '0000031', 0, '', '14misofita', '0000031', 0, 0, 1, 'jbravo@cideim.org.co', 'jackiebravoch@gmail.com', 0, 'CARRERA 125 No.19-225', '', 'CIDEIM', '', '00059', 0, '', 0, '#RES', 20130503),
(32, '0000032', 'Admin', '0000032', 0, '', 'proethos', '0000032', 0, 0, 1, 'admin', '', 0, 'Street name\r\nCx Box\r\nCity name', '', 'PAHO', '', '00240', 0, '', 0, '#RES#ADC', 20131002),
(35, '0000035', 'Rene Faustino Gabriel Junior', '0000035', 0, '', '448545ct', '0000035', 0, 0, -1, 'rene@fonzaghi.com.br', '', 0, 'Street name\r\nCx Box\r\nCity name', '', 'PUCPR', '', '00040', 0, '', 0, '#RES', 20131122),
(34, '0000034', 'Comite de Etica de la Universidad Peruana Cayetano Heredia', '0000034', 0, '', '!00Preuba', '0000034', 0, 0, -1, 'fredy.canchihuaman.r@upch.edu', '', 0, 'Av. Hnorio Delgado 430. SMP. Lima 31', '', '', '', '00182', 0, '', 0, '#RES', 20131021),
(39, '0000039', 'Rene Faustino Gabriel Junior', '0000039', 0, '', '448545ct', '0000039', 0, 0, 1, 'teste4@fonzaghi.com.br', '', 0, 'Street name\r\nCx Box\r\nCity name', '', 'PUCPR', '', '00040', 1, '', 0, '#RES', 20131122),
(1720, '0001720', 'teste', '0001720', 0, '', 'teste', '0001720', 0, 0, -1, 'teste@teset.com.br', '', 0, 'Street name\r\nCx Box\r\nCity name', '', 'New User Institution', '', '', 0, '', 0, '#RES', 20131212),
(1721, '0001721', 'Melissa Co', '0001721', 0, '', 'mannco2001', '0001721', 0, 0, 1, 'melissco@sas.upenn.edu', 'melissaa.co@gmail.com', 0, '', '', 'PAHO', '', '00078', 1, '', 0, '', 20140620);
...
--
-- Estrutura da tabela `usuario_perfis_ativo`
--
...
--
-- Extraindo dados da tabela `usuario_perfis_ativo`
--

INSERT INTO `usuario_perfis_ativo` (`id_up`, `up_perfil`, `up_usuario`, `up_data`, `up_data_end`, `up_ativo`) VALUES
(1, '#MAS', '0000008', 20120906, 19000101, 1),
(2, '#MEM', '0000008', 20120906, 19000101, 1),
(3, '#COO', '0000008', 20120906, 19000101, 1),
(4, '#ADM', '0000008', 20120906, 19000101, 1),
(5, '#ADM', '0000018', 20120906, 19000101, 1),
(6, '#ADM', '0000017', 20120906, 19000101, 1),
(7, '#MEM', '0000009', 20120912, 19000101, 1),
(8, '#MEM', '0000016', 20120912, 19000101, 1),
(9, '#MEM', '0000011', 20120912, 19000101, 1),
(10, '#ADM', '0000011', 20120912, 19000101, 1),
(11, '#RES', '0000009', 20120928, 19000101, 1),
(12, '#ADM', '0000025', 20121009, 19000101, 0),
(13, '#MAS', '0000025', 20121009, 19000101, 0),
(14, '#MEM', '0000025', 20121009, 19000101, 0),
(15, '#ADC', '0000025', 20121204, 19000101, 1),
(16, '#SCR', '0000010', 20130319, 19000101, 1),
(17, '#ADM', '0000010', 20130319, 19000101, 0),
(18, '#ADM', '0000029', 20130329, 19000101, 1),
(19, '#COO', '0000017', 20131030, 19000101, 1),
(20, '#RES', '0000017', 20131030, 19000101, 1),
(21, '#MEM', '0000017', 20131030, 19000101, 1),
(22, '#SCR', '0000017', 20131030, 19000101, 1),
(23, '#ADC', '0000032', 20140117, 19000101, 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `_committee`
--

CREATE TABLE IF NOT EXISTS `_committee` (
  `id_cm` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_cm` (`id_cm`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Extraindo dados da tabela `_committee`
--
...
CREATE TABLE IF NOT EXISTS `_messages` (
  ...
  UNIQUE KEY `is_msg` (`id_msg`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8209 ;

--
-- Extraindo dados da tabela `_messages`
--
...
(3571, '', 'es', 'prot_in_analysis', 'Propuestas siendo revisadas por el comitÃ©', 1, 0),
...
(3575, '', 'es', 'prot_rejected', 'Propuestas devueltas para correciÃ³n', 1, 0),
...
(3579, '', 'es', 'prot_aproved', 'Propuestas con decisiÃ³n', 1, 0),
...
(3637, '', 'pt_BR', 'top_submit_menu_5', 'Anexos, cronograma<BR>e orÃ§amento', 1, 0),
...
(3641, '', 'pt_BR', 'top_submit_menu_6', 'FinalizaÃ§Ã£o', 1, 0),
(3642, '', 'en_US', 'top_submit_menu_6', 'Validation Check', 1, 0),
(3643, '', 'es', 'top_submit_menu_6', 'Lista de validaciÃ³n', 1, 0),
(3644, '', 'fr', 'top_submit_menu_6', 'ContrÃ´le de Validation', 1, 0),
(3645, '', 'pt_BR', 'protocol_submit', 'Submeter o projeto', 1, 0),
(3646, '', 'en_US', 'protocol_submit', 'Submit Project', 1, 0),
(3647, '', 'es', 'protocol_submit', 'EnvÃ­e la propuesta', 1, 0),
...
(7859, '', 'es', 'PAHO-FOOT', 'OrganizaciÃ³n Panamericana de la Salud ', 1, 0),
...
(3735, '', 'es', 'login_cab', 'Iniciar SesiÃ³n', 1, 0),
...
(3759, '', 'es', 'new_user_info', 'InformaciÃ³n del nuevo usuario', 1, 0),
...
(7794, '', 'en_US', 'PÃ³liza de seguro', 'PÃ³liza de seguro', 1, 0),
...
(3905, '', 'pt_BR', 'specific_goal', 'Objetivos especÃ­ficos ', 1, 0),
(3906, '', 'en_US', 'specific_goal', 'Specific Objective(s)', 1, 0),
(3907, '', 'es', 'specific_goal', 'Objetivo(s) especÃ­fico(s)', 1, 0),
...
(4000, '', 'fr', 'not_file_posted', 'Aucun fichier publiÃ© ', 1, 0),
...
(4011, '', 'es', 'crono_desc', 'DescripciÃ³n de la actividad ', 1, 0),
...
(4063, '', 'es', 'dictame rechassada', 'DecisiÃ³n Rechazado', 1, 0),
...
(4199, '', 'es', 'pesq_revisao', 'Propuestas en tamizaje inicial del comitÃ©', 1, 0),
...
(4203, '', 'es', 'pesq_assignada', 'Propuestas en proceso de revisiÃ³n del comitÃ©', 1, 0),
...
(4207, '', 'es', 'pesq_reunion', 'Propuestas asignadas para prÃ³xima reuniÃ³n ', 1, 0),
...
(4211, '', 'es', 'pesq_filed', 'Propuestas en proceso de decisiÃ³n', 1, 0),
...
(4215, '', 'es', 'key_exclusion_inclusion', 'ExclusiÃ³n/InclusiÃ³n Claves', 1, 0),
...
(4219, '', 'es', 'key_inclusion', 'Criterios de inclusiÃ³n clave', 1, 0),
...
(4259, '', 'es', 'folha_rosto', 'PÃ¡gina principal/Portada', 1, 0),
...
(4275, '', 'es', 'local_pesq', 'LocaciÃ³n de la investigaciÃ³n ', 1, 0),
...
(4367, '', 'es', 'dictame', 'Lista de verificaciÃ³n', 1, 0),
(4368, '', 'fr', 'dictame', 'Liste de vÃ©rification ', 1, 0),
...
(4431, '', 'es', 'send_email_info', 'Enviar correo de informaciÃ³n', 1, 0),
...
(4443, '', 'es', 'resume_committee', 'Resumen para el comitÃ©', 1, 0),
...
(4459, '', 'es', 'submit_term', 'TÃ©rminos de presentaciÃ³n de la propuesta', 1, 0),
(4460, '', 'fr', 'submit_term', 'Conditions de soumission - Espace disponible pour toutes les modalitÃ©s de soumission. LÂ´ERC nÃ©cessite dans chaque pays lâ€™accord de lâ€™enquÃªteur avant de soumettre leur proposition.', 1, 0),
...
(4499, '', 'es', 'return_to_submission', 'Regresar presentaciÃ³n', 1, 0),
...
(4515, '', 'es', 'cep_status_B', 'Propuestas listas para revisiÃ³n', 1, 0),
...
(4525, '', 'pt_BR', 'question_1', '<B>1. Validade Social</B>\r\nO estudo pode contribuir para o aprimoramento cientÃ­fico e saÃºde? Qual o potencial valor da pesquisa para cada benefÃ­cio? ', 1, 0),
...
(4527, '', 'es', 'question_1', '<B>1. Valor social</B>\r\nÂ¿Puede el estudio mejorar la salud y el bienestar? Â¿CuÃ¡l es el valor potencial de la investigaciÃ³n para cada uno de los beneficiarios prospecto?', 1, 0),
...
(4531, '', 'es', 'question_2', '<B>2. Validez cientÃ­fica</B>\r\nÂ¿Es la investigaciÃ³n metodolÃ³gicamente vÃ¡lida y cientÃ­ficamente (y estadÃ­sticamente) rigurosa? Â¿GenerarÃ¡ el estudio datos vÃ¡lidos y confiables que pueden ser generalizables y Ãºtiles? Â¿Realiza el diseÃ±o del estudio los objetivos cientÃ­ficos al mismo tiempo que garantiza a los participantes las intervenciones en salud a las cuales tienen derecho? Â¿Es este un estudio factible?', 1, 0),
...
(4535, '', 'es', 'question_3', '<B>3. SelecciÃ³n justa de participantes</B>\r\nÂ¿Cuales son los criterios de inclusion y exclusion de participantes? Â¿Se basa la selecciÃ³n de participantes en criterios cientÃ­ficos? Â¿Se selecciona la poblaciÃ³n de la investigaciÃ³n para minimizer los riesgos de los participantes? Â¿Se selecciona a los participantes individuales de la investigaciÃ³n para maximar los posibles beneficios? Si hay participantes vulnerables, Â¿existen salvaguardas para protegerlos de daÃ±os? Â¿Se distribuyen equitativamente los riesgos y posibles beneficios del estudio?', 1, 0),
...
(4539, '', 'es', 'question_4', '<B>4. RelaciÃ³n favorable de riesgo-beneficio</B> Â¿Pueden minimizarse los riesgos para los participantes? Â¿Pueden mejorarse los posibles beneficios para los individuos y para la sociedad? Los posibles beneficios para la sociedad e individuos, Â¿sobrepasan los riesgos?', 1, 0),
...
(4595, '', 'es', 'confirm_email', 'Estimado investigador,\r\n\r\nSu registro fuÃ© exitoso, pero aun no esta active. RecibirÃ¡ un correo electrÃ³nico para validar su registro.\r\n\r\nSaludos,\r\n\r\nComitÃ© de Ã‰tica', 1, 0),
(4596, '', 'fr', 'confirm_email', 'Cher EnquÃªteur, votre inscription a Ã©tÃ© un succÃ¨s, mais nâ€™est pas encore active. Vous recevrez un e-mail pour valider lÂ´inscription. Cordialement, ComitÃ© dÂ´Ã©thique', 1, 0),
...
(4607, '', 'es', 'chk_email_ok', 'Querido investigador la validaciÃ³n de su registro se ha realizado correctamente. A partir de este momento, usted es libre de acceder al sistema de presentaciÃ³n de proyectos en lÃ­nea del ComitÃ© de Ã‰tica de la InvestigaciÃ³n.', 1, 0),
(4608, '', 'fr', 'chk_email_ok', 'Cher EnquÃªteur,\r\nLa  validation de votre inscription a Ã©tÃ© une rÃ©ussite. Vous Ãªtes  maintenant libre dÂ´accÃ©der au systÃ¨me soumission de projet de la Commission de lÂ´Ã‰thique de Recherche.', 1, 0),
...
(4771, '', 'es', 'cancel_submission', 'Cancelar presentaciÃ³n de propuesta', 1, 0),
...
(4875, '', 'es', 'q_title_main_inf', 'TÃ­tulo en lenguaje comprensible para el publico no especializado ', 1, 0),
...
(4891, '', 'es', 'title_main_inf', 'TÃ­tulo cientÃ­fico del estudio tal como aparece en el protocolo presentado para financiamiento y revisiÃ³n Ã©tica. Incluya las siglas del ensayo si aplica. ', 1, 0),
(4892, '', 'fr', 'title_main_inf', 'Titre scientifique de lÂ´Ã©tude comme il \r\napparait dans le protocole soumit pour les \r\nfonds et la rÃ©vision Ã©thique. Inclure \r\nlÂ´acronyme de lÂ´ essai si disponible.', 1, 0),
(4893, '', 'pt_BR', 'title_public_inf', 'TÃ­tulo destinado ao pÃºblico leigo facilmente compreendida na\r\nlÃ­ngua.', 1, 0),
...
(4899, '', 'es', '_inf', '', 1, 0),
(4900, '', 'fr', '_inf', '', 1, 0),
(4901, '', 'pt_BR', 'keywords_inf', 'Inserir de trÃªs a cinco palavras chave separadas \r\npor ponto e \r\nvirgula ou ponto.', 1, 0),
...
(4931, '', 'es', 'Materials and Methods_inf', 'Materiales y mÃ©todos', 1, 0),
...
(4965, '', 'pt_BR', 'primary_outcome_inf', 'InformaÃ§Ãµes sobre eventuais resultados preliminares', 1, 0),
(4966, '', 'en_US', 'primary_outcome_inf', 'Primary Outcome Info', 1, 0),
(4967, '', 'es', 'primary_outcome_inf', 'InformaciÃ³n sobre resultados principales', 1, 0),
(4968, '', 'fr', 'primary_outcome_inf', 'Informations sur les rÃ©sultats principaux ', 1, 0),
(4969, '', 'pt_BR', 'seconday_outcome_inf', 'seconday_outcome_inf', 1, 0);
INSERT INTO `_messages` (`id_msg`, `msg_pag`, `msg_language`, `msg_field`, `msg_content`, `msg_ativo`, `msg_update`) VALUES
(4970, '', 'en_US', 'seconday_outcome_inf', 'Secondary Outcome Info', 1, 0),
(4971, '', 'es', 'seconday_outcome_inf', 'InformaciÃ³n sobre resultados secundarios', 1, 0),
(4972, '', 'fr', 'seconday_outcome_inf', 'Informations sur les rÃ©sultats secondaires', 1, 0),
...
(5043, '', 'es', 'action_accept_direct', 'Si requiere revisiÃ³n Ã©tica por parte del comitÃ©', 1, 0),
...
(5091, '', 'es', 'pesq_check', 'Para tamizaje del ComitÃ©', 1, 0),
...
(5107, '', 'es', 'action_survey', 'OpiniÃ³n de miembro del ComitÃ©', 1, 0),
...
(5263, '', 'es', 'abstract_inf', 'Provea un breve resumen de la propuesta y sus componentes. Esta seccion deberÃ­a mencionar brevemente el valor potencial de esta investigaciÃ³n.', 1, 0),
...
(5335, '', 'es', 'primary_register_inf', 'InformaciÃ³n del Registro Primario', 1, 0),
...
(5339, '', 'es', 'sencondary_register_inf', 'InformaciÃ³n de Registro Secundario', 1, 0),
...
(5375, '', 'es', 'abstract_field_inf', 'Campo_resÃºmen_inf', 1, 0),
(5376, '', 'fr', 'abstract_field_inf', 'abstract_field_inf', 1, 0),
(5377, '', 'pt_BR', 'reserach_name', 'Pesquisador', 1, 0),
(5378, '', 'en_US', 'reserach_name', 'Investigatorï¿½s Name', 1, 0),
(5379, '', 'es', 'reserach_name', 'Nombre del investigador', 1, 0),
(5380, '', 'fr', 'reserach_name', 'Nom de lâ€™ enquÃªteurs', 1, 0),
...
(5387, '', 'es', 'about_cep', 'Acerca del ComitÃ©', 1, 0),
...
(5415, '', 'es', 'submit_process', 'PresentaciÃ³n de propuesta de investigaciÃ³n', 1, 0),
...
(7522, '', 'en_US', 'Modo de ediÃ§Ã£o desabilitado', 'Modo de ediÃ§Ã£o desabilitado', 1, 0),
...
(5488, '', 'fr', 'contacts', 'Contact du public avec lâ€™ enquÃªteur', 1, 0),
...
(5539, '', 'es', 'Local Ethical Approval', 'DecisiÃ³n del ComitÃ©', 1, 0),
(5540, '', 'fr', 'Local Ethical Approval', 'Approbation locale de lÂ´Ã©thique ', 1, 0),
...
(5591, '', 'es', 'subm_to_accept', 'Propuestas pendientes para validaciÃ³n de datos', 1, 0),
...
(5595, '', 'es', 'project_title', 'TÃ­tulo del proyecto', 1, 0),
...
(5602, '', 'en_US', 'project_investigador', 'InvestigatorÂ´s projects', 1, 0),
...
(5623, '', 'es', 'admin_post_mail', 'ComunicaciÃ³n vÃ­a correo electrÃ³nico ', 1, 0),
...
(5645, '', 'pt_BR', 'action_accept_rejected_inf', 'A rejeiÃ§Ã£o do protocolo pela secretaria faz com que o protocolo seja devolvido ao investigador \r\npara correÃ§Ã£o dos problemas, deve-se informar os problemas na caixa de texto. Com esta opÃ§Ã£o o \r\nsistema devolve automaticamente para ediÃ§Ã£o do investigador.', 1, 0),
...
(5683, '', 'es', 'caption_status_$', 'Problemas con la presentaciÃ³n del proyecto', 1, 0),
...
(5688, '', 'fr', 'caption_status_$_inf', 'SÂ´il vous plaÃ®t sÃ©lectionnez votre projet et rÃ©viser', 1, 0),
(5689, '', 'pt_BR', 'message_$_inf', 'Caro investigador,\r\n<BR>\r\n<BR>Por favor esteja atento Ã s mensagens abaixo e clique em "Editar seu projeto" para modificar sua submissÃ£o.', 1, 0),
...
(5691, '', 'es', 'message_$_inf', 'Estimado investigador,\r\n<BR>\r\n<BR>Por favor lea el mensaje adjunto y haga "click" en "editar este proyecto" para modificar su presentaciÃ³n.', 1, 0),
(5692, '', 'fr', 'message_$_inf', 'Cher EnquÃªteur,\r\nSÂ´il vous plaÃ®t, voir les messages postÃ©s ci-dessous et cliquez sur "modifier ce projet" pour modifier votre soumission.', 1, 0),
...
(5703, '', 'es', 'caption_status_', 'Todos los proyectos de investigaciÃ³n', 1, 0),
...
(5707, '', 'es', 'caption_status__inf', 'Seleccione el projecto de investigaciÃ³n que desee ver o continuar.', 1, 0),
...
(5713, '', 'pt_BR', 'caption_status_@_inf', 'Os projetos abaixo estÃ£o em modo de ediÃ§Ã£o, <B>nÃ£o foram</B> submetidos ao ComitÃª de Ã‰tica para \r\nanÃ¡lise.', 1, 0),
...
(5811, '', 'es', 'submission_problems', 'Problema en la presentaciÃ³n', 1, 0),
...
(5899, '', 'es', 'draft_opinion', 'Escribir opiniÃ³n', 1, 0),
...
(5915, '', 'es', 'pesq_relate', 'Propuestas asignadas para mi revisiÃ³n', 1, 0),
...
(5919, '', 'es', 'cep_status_Z', 'Proyecto para mi revisiÃ³n', 1, 0),
...
(5923, '', 'es', 'action_012', 'Emitir decisiÃ³n final', 1, 0),
...
(5991, '', 'es', 'save_dictamen', 'Guardar opiniÃ³n', 1, 0),
...
(6002, '', 'en_US', 'dictamen_1', 'Validez cientÃ­fica', 1, 0),
...
(6006, '', 'en_US', 'dictamen_2', 'SelecciÃ³n justa de participantes', 1, 0),
...
(6131, '', 'es', 'secretaty_revision', 'Propuestas bajo revisiÃ³n de la secretarÃ­a', 1, 0),
...
(6140, '', 'fr', 'menu_documents', 'ModÃ¨les de documents\r\n', 1, 0),
...
(6144, '', 'fr', 'documents_title', 'ModÃ¨les de documents', 1, 0),
(7868, '', 'fr', 'PUCPR-FOOT', 'PontifÃ­cia Universidade CatÃ³lica do ParanÃ¡ ', 1, 0),
(7867, '', 'es', 'PUCPR-FOOT', 'PontifÃ­cia Universidade CatÃ³lica do ParanÃ¡ ', 1, 0),
(7866, '', 'en_US', 'PUCPR-FOOT', 'PontifÃ­cia Universidade CatÃ³lica do ParanÃ¡ ', 1, 0),
...
(6239, '', 'es', 'action_notification_only', 'NotificaciÃ³n solamente - Este proyecto no sera revisado por el comitÃ©', 1, 0),
...
(6283, '', 'es', 'proto_cab_6', 'InvestigaciÃ³n en curso', 1, 0),
...
(6355, '', 'es', 'minimum age', 'Edad MÃ­nima', 1, 0),
...
(6431, '', 'es', 'admin_parecer_modelo', 'Plantillas de decisiÃ³n', 1, 0),
...
(6491, '', 'es', 'parecer_modelo', 'Modelos de decisiÃ³n', 1, 0),
...
(6503, '', 'es', 'country_sample_size', 'TamaÃ±o de la muestra del pais', 1, 0),
...
(6629, '', 'pt_BR', 'ghost_instruction', 'Neste modo o ADMIN pode assumir o perfil de qualquer usuÃ¡rio cadastrado no sistema, desde a submissÃ£o de propostas como ediÃ§Ã£o de \r\npareceres e votaÃ§Ãµes.\r\n<BR><BR>\r\nClique no nome do usuÃ¡rio para ativar o modo fantasma', 1, 0),
(6630, '', 'en_US', 'ghost_instruction', 'The Proxy mode allows the user to take another userÂ´s role in order to be able to submit proposals, make editions and cast votes.\r\n<BR><BR>\r\nClick the name of the user to activate the proxy mode.', 1, 0),
...
(6651, '', 'es', 'decision_sistema_pucpr_aprobado.doc', 'DecisiÃ³n Aprobado.doc', 1, 0),
...
(7523, '', 'es', 'Modo de ediÃ§Ã£o desabilitado', 'Modo de ediÃ§Ã£o desabilitado', 1, 0),
...
(6695, '', 'es', 'decision_oficial', 'DecisiÃ³n oficial', 1, 0),
...
(6731, '', 'es', 'communicate_investigator_inf', 'Comunicar informaciÃ³n del investigador', 1, 0),
...
(6737, '', 'pt_BR', 'reedit_draft_opinion_inf', 'Pareceres com problemas gramaticais ou na consistÃªncia do parecer podem ser reeditados.', 1, 0),
(6738, '', 'en_US', 'reedit_draft_opinion_inf', 'Revise Decision', 1, 0),
(6739, '', 'es', 'reedit_draft_opinion_inf', 'Revisar decisiÃ³n', 1, 0),
...
(6755, '', 'es', 'research_ongoing', 'Propuestas con decisiÃ³n', 1, 0),
...
(6767, '', 'es', 'committee_reports', 'Reportes de ComitÃ©', 1, 0),
...
(6846, '', 'en_US', 'local_ethical', 'Indicate whether the research protocol has already been approved by a local ethics committee or, in its absence, by the countryÂ´s Minister of Health. Any previous ethics approval must be attached.', 1, 0),
...
(6867, '', 'es', 'report_004_inf', 'Miembros del ComitÃ©', 1, 0),
...
(7003, '', 'es', 'about_committe', 'Personalizar informaciÃ³n sobre el comitÃ©', 1, 0),
...
(7093, '', 'pt_BR', 'fonte_finaciamento_inf', 'InformaÃ§Ã£o da fonte de financiamento', 1, 0),
(7094, '', 'en_US', 'fonte_finaciamento_inf', 'Funding Source Info', 1, 0),
(7095, '', 'es', 'fonte_finaciamento_inf', 'InformaciÃ³n de la fuente de financiamiento', 1, 0),
...
(7163, '', 'es', 'secretary_menu', 'Menu de la secretarÃ­a', 1, 0),
...
(7187, '', 'es', 'login_failed', 'correo electrÃ³nico o la contraseÃ±a son incorrectos', 1, 0),
...
(7985, '', 'pt_BR', 'human_check', 'Para validar o cadastro informe no campo abaixo somente os <B>nÃºmeros</B> do cÃ³digo abaixo.', 1, 0),
(7986, '', 'en_US', 'human_check', 'To validate the report only joined in the field below the code numbers below.', 1, 0),
(7987, '', 'es', 'human_check', 'Para validar el informe sÃ³lo se uniÃ³ en el campo por debajo de los nÃºmeros de cÃ³digo de abajo.', 1, 0),
(7988, '', 'fr', 'human_check', '\r\nPour valider le rapport ne rejoint dans le champ ci-dessous les numÃ©ros de code ci-dessous.', 1, 0),
(7989, '', 'pt_BR', 'type_number', 'Digite <B>somente</B> os nÃºmeros', 1, 0),
...
(8042, '', 'en_US', 'admin_menu_special', 'Special AdministratorÂ´s Menu', 1, 0),
(8043, '', 'es', 'admin_menu_special', 'Special AdministratorÂ´s Menu', 1, 0),
...
(8069, '', 'pt_BR', 'proethos_doc_diap', '-Parecer de aprovaÃ§Ã£o', 1, 0),
(8070, '', 'en_US', 'proethos_doc_diap', '-Approval', 1, 0),
(8071, '', 'es', 'proethos_doc_diap', '-AprobaciÃ³n', 1, 0),
(8072, '', 'fr', 'proethos_doc_diap', '-Approval', 1, 0),
(8073, '', 'pt_BR', 'proethos_doc_diac', '-Parecer de aprovaÃ§Ã£o condicional', 1, 0),
(8074, '', 'en_US', 'proethos_doc_diac', '-Conditional approval', 1, 0),
(8075, '', 'es', 'proethos_doc_diac', '-AprobaciÃ³n condicionalproethos_doc_diac', 1, 0),
(8076, '', 'fr', 'proethos_doc_diac', '-Conditional approval', 1, 0),
(8077, '', 'pt_BR', 'proethos_doc_dina', '-Modelo de nÃ£o aprovado', 1, 0),
(8078, '', 'en_US', 'proethos_doc_dina', '-Non approval', 1, 0),
(8079, '', 'es', 'proethos_doc_dina', '-No aprobaciÃ³n', 1, 0),
